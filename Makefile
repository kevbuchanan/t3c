...
spec: bin/test.o bin/spec_helper.o bin/board.o bin/board_test.o bin/presenter.o bin/presenter_test.o bin/minimax.o bin/minimax_test.o bin/player.o bin/player_test.o bin/test_writer.o bin/game.o bin/game_test.o
	cc -o spec bin/test.o bin/spec_helper.o bin/board.o bin/board_test.o bin/presenter.o bin/presenter_test.o bin/minimax.o bin/minimax_test.o bin/player.o bin/player_test.o bin/test_writer.o bin/game.o bin/game_test.o
